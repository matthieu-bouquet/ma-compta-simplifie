...
export default function PlanComptablePageClient({
  ...
  initialTemplateCode?: ChartTemplateCode
  ...
  useEffect(() => {
    if (templateCode === initialTemplateCode && initialPlan.length > 0) {
      return
    }
  ...
  }, [loadPlanComptable, templateCode, initialTemplateCode, initialPlan.length])
