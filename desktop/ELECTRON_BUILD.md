...
| **Quand migrer** | À **chaque** démarrage prod : `prisma migrate deploy` (no-op si rien en attente). Le marqueur `db-migrations.json` trace la dernière exécution / version app. |
